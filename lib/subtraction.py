...
def subtract():
    ...
    print(
        f"Result of SUBTRACTION : {first_num} - {second_num} = {first_num - second_num}")
    return first_num - second_num


def subtract_2_numbers(first_num, second_num):
    """
    ...
    print(
        f"SUBTRACT Result : {first_num} - {second_num} = {first_num - second_num}")
    return result
