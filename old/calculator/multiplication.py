...
def multiplying_2_numbers(first_num, second_num):
    """
...
def multiply_required_numbers():
    ...
    """
    result_prod = 1
    how_many_numbers = int(input("How many Numbers Do you want to Multiply.? "))
    for number in range(how_many_numbers):
        result_prod *= int(input("Enter the Number-" + str(number + 1) + " : "))
    return result_prod
